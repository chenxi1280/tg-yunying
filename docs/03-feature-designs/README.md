...
| [search-dispatch-release-fence-hotfix.md](search-dispatch-release-fence-hotfix.md) | **2026-08-19 `034216e4` fence E4 通过、通用 Recovery 投影补缺待二次发布**：Stage B 真实收口 2 条搜索 Action，未重发且发布后搜索/群发事实继续；遗漏审计补充 fact-first unknown 统一幂等投影与 legacy deadline 收口，27 项定向 QA 通过 |
