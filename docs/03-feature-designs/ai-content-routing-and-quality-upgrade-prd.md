...
确定性闸不要求每条 sensory 必须逐字出现“润/水多/湿”；这些词是可接受人工锚点，不是模板。sensory 意图、自然度和是否接住成人服务语境由在线 semantic reviewer 判定；离线按 anchor family 统计覆盖与多样性，单条只硬拦截未授权成人、错误对象、禁用 claim 和安全问题。
