...
- 频道任务需要补齐启动前关注频道阶段：手动添加频道后，任务启动时应先让账号范围内未关注的账号按抖动节奏关注频道，再进入浏览、点赞、评论或回复执行。
...
- 运营人员可以通过 `@username`、公开频道链接、邀请链接或已知 peer id 手动添加频道目标；其中 peer id 更适合作为已同步目标识别，无法保证单独完成关注。
