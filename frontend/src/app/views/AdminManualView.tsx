...
const moduleGuides = [
  ...
  },
  {
    ...
    steps: ['选择任务类型和运营目标，或直接粘贴群聊/频道入口', '使用默认节奏创建，必要时展开高级设置', '创建并启动，或先保存草稿再启动', '任务会先检查账号是否已关注或已加入', '未满足账号先按抖动节奏关注或加入目标', '已满足账号先进入主互动，准备成功账号后续追加执行', '在任务详情查看准入前置、执行项、账号分配和失败原因'],
