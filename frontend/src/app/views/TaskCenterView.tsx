...
const OPERATION_PROFILE_TEMPLATES = [
...
type OperationProfileTemplateId = typeof OPERATION_PROFILE_TEMPLATES[number]['value'];
...
function curveNumbers(value?: Array<number | string> | string | null): number[] {
...
function operationProfileSummary(values: Record<string, any>): string {
...
function currentOperationProfile(values: Record<string, any>) {
...
function accountPrecheck(values: Record<string, any>, accounts: Account[], accountPools: AccountPool[]) {
...
function ruleSummary(values: Record<string, any>, ruleSets: RuleSet[]) {
...
function targetName(values: Record<string, any>, targets: OperationTarget[]) {
...
function WizardOperationProfile({ form, values }: { form: any; values: Record<string, any> }) {
...
function TaskRuntimeAdvancedFields() {
  return (
    <>
