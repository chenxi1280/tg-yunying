...
const adminPermissionGroups = [
  ...
  { menu: ['accounts.view', 'TG账号管理'], buttons: [
    ...
    ['accounts.login', '账号登录'],
    ['accounts.batch_login', '批量登录'],
    ['accounts.code_source_credentials.read', '查看接码 UUID'],
    ['accounts.sync', '账号同步'],
  ...
  { menu: ['tasks.view', '任务中心'], buttons: [['tasks.manage', '任务管理'], ['tasks.create.search_click', '创建纯搜索点击'], ['tasks.dispatch_control', '调度控制']] },
