...
function AppShell() {
  ...
  const {
    ...
    runtime, accountCreationCapability, overview,
    accountPools, selectedPoolId, setSelectedPoolId, accounts, setAccounts, accountTotal, setAccountTotal, selectedPool,
