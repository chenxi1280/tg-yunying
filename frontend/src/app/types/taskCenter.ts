...
export type TaskCenterDetail = {
  ...
  message_groups: Array<{
    ...
    acceptance?: {
      ...
      quality_target_current_revision?: number;
      quality_target_effective_revision?: number;
      quality_target_revision_state?: string;
      quality_target_component_count?: number;
      semantic_capacity_state?: string;
      applicable_grounding_ordinal_count?: number;
      unadjusted_grounding_target_count?: number;
      groundable_capacity_count?: number;
      planned_fallback_target_count?: number;
      planned_fallback_confirmed_count?: number;
      quality_target_unassigned_ordinal_count?: number;
      quality_target_not_applicable_ordinal_count?: number;
      quality_target_shortfall_ordinal_count?: number;
    };
    actions: TaskCenterAction[];
  }>;
  ai_cycles: Array<{
