...
export type TaskCenterDetail = {
  ...
  channel_comment_discussion?: {
    selection_mode?: 'all' | 'group' | 'manual';
    configured_account_ids?: number[];
    raw_online_count?: number;
    base_operational_candidate_count?: number;
    discussion_membership_ready_count?: number;
    discussion_admission_required_count?: number;
    discussion_forbidden_count?: number;
    discussion_membership_unknown_count?: number;
    comment_contract_eligible_count?: number;
    effective_comment_ready_count?: number;
    binding?: Record<string, any>;
    enrollment?: Record<string, any>;
    listener?: Record<string, any>;
  };
  channel_comment_grounding?: {
    messages?: Array<{
      snapshot_id: string;
      channel_message_id: number;
      source_message_id: number;
      comment_grounding_revision: number;
      content_route: string;
      grounding_contract_version: string;
      extractor_version: string;
      source_content_hash: string;
      source_published_at?: string;
      source_observed_at?: string;
      telegram_edit_date?: string;
      source_state: string;
      teacher_state: string;
      teacher_candidates: Array<Record<string, any>>;
      aspect_evidence: Array<Record<string, any>>;
  ...
  message_groups: Array<{
    ...
    acceptance?: {
      ...
      quantity_uncapped_target_count?: number;
      quantity_confirmed_count?: number;
      business_max_comments_per_message?: number;
      business_cap_state?: string;
      business_cap_adjusted_count?: number;
      ...
      planned_fallback_limit_count?: number;
      fallback_business_state?: string;
