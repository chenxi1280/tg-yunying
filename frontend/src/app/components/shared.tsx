...
export function statusTone(status: string | null | undefined): BadgeTone {
  ...
  if (['失败', '受限', '异常', '需重新登录', 'Session失效', '疑似封禁', '已封禁', '禁止操作', '已取消', '禁用', '账号不可发言', '不可发言', '内容违规', '账号不可用', '账号受限', '群无权限', '群慢速模式', 'FloodWait', '目标无效', '未知错误', '部分失败', '有失败', '人工停止', '已暂停', '已删除', 'failed', 'rejected', 'paused', 'stopped', 'deleted'].includes(value)) return 'danger';
