...
def _ai_turn_payload(action: Action, payload: dict[str, Any], default_turn_index: int) -> dict[str, Any]:
    return {
        ...
        "provider_duration_ms": _payload_int(payload, "provider_duration_ms"),
        "generation_attempts": payload.get("generation_attempts") if isinstance(payload.get("generation_attempts"), list) else [],
