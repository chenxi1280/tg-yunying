...
CONTACT_PATTERNS = re.compile(
    r"(?:"
    # 1. 微信类
    r"微信|微信号|加v|v同步|vx|weixin|企微|加我v|留v|加威|威信|威同|"
    # 2. 手机/电话类
    r"(?:\+?86)?1[3-9]\d{9}|(?:\+?86)?1[3-9]\d[- ]?\d{4}[- ]?\d{4}|(?:电话|手机|致电|拨打|tel|phone)[：:\s]*\d+|"
    # 3. QQ类
    r"(?:qq|企鹅|扣扣|QQ号)[：:\s]*[1-9]\d{4,10}|"
    # 4. TG/外链/私聊类
    r"@[A-Za-z0-9_]{3,}|https?://\S+|t\.me/[A-Za-z0-9_+/]+|www\.\S+|telegram|tg号|\btg\b|私聊|私信|加我|联系方式|联系电话|留联系方式"
    r")",
    re.IGNORECASE,
)
FORBIDDEN = re.compile(
    ...
    r"微信|微信号|加v|v同步|vx|weixin|企微|加我v|留v|加威|威信|威同|"
    r"qq|企鹅|扣扣|QQ号|telegram|tg号|\btg\b|私聊|私信|加我|联系方式|联系电话|留联系方式|"
    r"@[A-Za-z0-9_]{3,}|https?://\S+|t\.me/[A-Za-z0-9_+/]+|www\.\S+|"
    r"(?:\+?86)?1[3-9]\d{9}|(?:\+?86)?1[3-9]\d[- ]?\d{4}[- ]?\d{4}|"
    r"(?:qq|企鹅|扣扣|QQ号|电话|手机|致电|拨打)[：:\s]*\d+|"
