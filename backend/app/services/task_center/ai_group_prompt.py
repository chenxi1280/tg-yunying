...
FORBIDDEN = re.compile(
    ...
    r"微信|联系方式|联系我|私聊|私信|加我|用户名|telegram|\btg\b|@[A-Za-z0-9_]{3,}|"
    r"地址|定位|酒店|宾馆|房间|开房|上门|到店|预约|预订|安排|档期|可约|"
    r"资源|求推荐|有没有好|上牌|上车|服务|妹妹|小妹|技师|楼凤|外围|全套|半套|"
    r"口活|做爱|性交|约炮|招嫖|嫖客|包养|面付|抓龙筋|可外|可包时|"
