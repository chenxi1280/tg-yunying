...
TYPE_SETTINGS_FIELDS = {
    ...
    "channel_view": {
        ...
        "account_group_ids",
        "concurrency_limit_per_group",
        "account_ratio_min_bps",
        "account_ratio_max_bps",
        "rolling_participation_days",
        "view_exposure_mode",
        "per_account_source_degree_min",
        "per_account_source_degree_max",
        "every_active_message",
        "per_source_exposure_target",
