...
class AccountEnvironmentBinding(Base):
    ...
    __table_args__ = (
        UniqueConstraint(
            ...
            "authorization_id",
            "session_role",
            name="uq_account_environment_app_authorization_role",
        ),
        Index("ix_account_environment_account", "tenant_id", "account_id", "status"),
        Index("ix_account_environment_app", "tenant_id", "account_id", "developer_app_id", "session_role"),
...
class FingerprintComboHistory(Base):
    ...
    __table_args__ = (
        ...
        Index("ix_fingerprint_combo_history_account", "tenant_id", "account_id", "developer_app_id", "authorization_id"),
    )
