...
class MaterialGroup(Base):
    ...
    membership_revision: Mapped[int] = mapped_column(Integer, default=1)
    membership_state: Mapped[str] = mapped_column(String(24), default="ready")
    membership_state_reason: Mapped[str] = mapped_column(String(160), default="")
