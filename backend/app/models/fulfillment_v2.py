...
class GenerationJob(Base):
    ...
    task_binding_hash: Mapped[str] = mapped_column(String(64), default="")
    window_slot_id: Mapped[str | None] = mapped_column(String(36), nullable=True)
    window_plan_hash: Mapped[str] = mapped_column(String(64), default="")
    task_direction_snapshot_hash: Mapped[str] = mapped_column(String(64), default="")
    content_policy_hash: Mapped[str] = mapped_column(String(64), default="")
    context_route: Mapped[str] = mapped_column(String(40), default="")
    content_mode: Mapped[str] = mapped_column(String(64), default="")
    route_evidence_hash: Mapped[str] = mapped_column(String(64), default="")
    prompt_contract_version: Mapped[str] = mapped_column(String(80), default="")
    example_set_version: Mapped[str] = mapped_column(String(80), default="")
    voice_profile_version: Mapped[str] = mapped_column(String(80), default="")
    provider_route_set_id: Mapped[str | None] = mapped_column(String(36), nullable=True)
    provider_route_set_revision: Mapped[int] = mapped_column(Integer, default=0)
    provider_route_set_hash: Mapped[str] = mapped_column(String(64), default="")
    provider_route_snapshots: Mapped[dict] = mapped_column(JSON, default=dict)
    request_hash: Mapped[str] = mapped_column(String(64), default="")
    generation_stage: Mapped[str] = mapped_column(String(32), default="routing")
    stage_version: Mapped[int] = mapped_column(Integer, default=1)
    next_retry_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
    latest_safe_send_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
