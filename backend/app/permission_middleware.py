...
PERMISSION_RULES: list[PermissionRule] = [
    ...
    _compile("PATCH", r"^/api/tasks/\d+/search_rank_deboost_config$", "tasks.manage.search_rank_deboost"),
    _compile("POST", r"^/api/tasks/\d+/search_rank_deboost_reroll_exempt_group$", "tasks.manage.search_rank_deboost"),
