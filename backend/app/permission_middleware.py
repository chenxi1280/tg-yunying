...
PERMISSION_RULES: list[PermissionRule] = [
    ...
    _compile("GET", r"^/api/system/runtime/planner-pressure$", "system.view"),
    ...
    _compile("GET", r"^/api/proxy-airport-subscriptions(?:/.*)?$", "system.view"),
    _compile("GET", r"^/api/account-environment-bindings$", "account_masks.view"),
    _compile("GET", r"^/api/account-environment-bindings/proxy-airport-nodes$", "account_masks.view"),
    ...
    _compile("GET", r"^/api/ai-account-voice-profile-generation-jobs(?:/.*)?$", "account_masks.view"),
    ...
    _compile("POST", r"^/api/ai-account-voice-profile-generation-(?:jobs|items)(?:/.*)?$", "ai_voice_profiles.manage"),
    _compile("PATCH", r"^/api/ai-account-voice-profiles(?:/.*)?$", "ai_voice_profiles.manage"),
    _compile("POST", r"^/api/account-environment-bindings/refresh-observations$", "account_environment.manage"),
    _compile("POST", r"^/api/account-environment-bindings/batch-proxy-bind$", "account_environment.manage"),
    _compile("PATCH", r"^/api/account-environment-bindings(?:/.*)?$", "account_environment.manage"),
    ...
    _compile("POST", r"^/api/proxy-airport-subscriptions(?:/.*)?$", "system.manage"),
    _compile("PATCH", r"^/api/proxy-airport-subscriptions(?:/.*)?$", "system.manage"),
    ...
    _compile("POST", r"^/api/tasks/[^/]+/search_rank_deboost_reroll_exempt_group$", "tasks.manage.search_rank_deboost"),
