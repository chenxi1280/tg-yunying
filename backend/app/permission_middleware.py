...
PERMISSION_RULES: list[PermissionRule] = [
    ...
    _compile("POST", r"^/api/tg-accounts/security-batches/precheck$", ("accounts.security.batch", "accounts.profile.batch_update", "accounts.authorizations.manage")),
    _compile("POST", r"^/api/tg-accounts/security-batches(?:/.*)?$", ("accounts.security.batch", "accounts.profile.batch_update", "accounts.authorizations.manage")),
