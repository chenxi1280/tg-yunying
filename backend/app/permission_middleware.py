...
PERMISSION_RULES: list[PermissionRule] = [
    ...
    _compile("GET", r"^/api/operation-targets/\d+/learning-(?:profile|samples|versions)(?:/.*)?$", "target_learning.view"),
    ...
    _compile("GET", r"^/api/listeners/(?:channel|group)/\d+/learning-(?:profile|samples)$", "target_learning.view"),
    ...
    _compile("POST", r"^/api/operation-targets/\d+/learning/rebuild$", "target_learning.rebuild"),
    _compile("POST", r"^/api/operation-targets/\d+/learning-versions/[^/]+/restore$", "target_learning.rebuild"),
    _compile("POST", r"^/api/operation-targets/\d+/learning/(?:disable|enable|clear-profile)$", "target_learning.manage"),
    _compile("PATCH", r"^/api/operation-targets/\d+/learning-samples/[^/]+$", "target_learning.manage"),
    ...
    _compile("POST", r"^/api/listeners/(?:channel|group)/\d+/refresh$", "target_learning.manage"),
