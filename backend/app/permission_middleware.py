...
PERMISSION_RULES: list[PermissionRule] = [
    ...
    _compile("POST", r"^/api/materials(?:/upload(?:/batch)?)?$", "materials.upload"),
    _compile("PATCH", r"^/api/materials(?:/.*)?$", "materials.manage"),
    _compile("POST", r"^/api/(?:prompt-templates|content-keyword-rules)(?:/.*)?$", "system.manage"),
    _compile("PATCH", r"^/api/(?:prompt-templates|tenant-ai-settings|content-keyword-rules|scheduling-settings)(?:/.*)?$", "system.manage"),
