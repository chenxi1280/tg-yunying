...
class Settings:
    ...
    antigravity_cli_enabled: bool = _bool_env("ANTIGRAVITY_CLI_ENABLED", False)
    antigravity_cli_bin: str = os.getenv("ANTIGRAVITY_CLI_BIN", "/root/.local/bin/agy")
    antigravity_cli_model: str = os.getenv("ANTIGRAVITY_CLI_MODEL", "gemini-3.5-flash")
    antigravity_cli_effort: str = os.getenv("ANTIGRAVITY_CLI_EFFORT", "medium")
    antigravity_cli_timeout_seconds: int = int(os.getenv("ANTIGRAVITY_CLI_TIMEOUT_SECONDS", "90"))
    antigravity_cli_lock_path: str = os.getenv("ANTIGRAVITY_CLI_LOCK_PATH", "/tmp/tgyunying-antigravity-cli.lock")
    ...
    enable_state_specific_action_retention: bool = _bool_env("ENABLE_STATE_SPECIFIC_ACTION_RETENTION", False)
    runtime_action_skipped_retention_days: int = int(os.getenv("RUNTIME_ACTION_SKIPPED_RETENTION_DAYS", "1"))
    runtime_action_success_retention_days: int = int(os.getenv("RUNTIME_ACTION_SUCCESS_RETENTION_DAYS", "2"))
    runtime_action_failed_retention_days: int = int(os.getenv("RUNTIME_ACTION_FAILED_RETENTION_DAYS", "7"))
