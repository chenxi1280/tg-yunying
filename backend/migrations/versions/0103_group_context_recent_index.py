"""index recent group context reads

Revision ID: 0103_group_context_recent_index
Revises: 0102_ai_memory_updated_index
...
revision = "0103_group_context_recent_index"
down_revision = "0102_ai_memory_updated_index"
branch_labels = None
depends_on = None

TABLE_NAME = "group_context_messages"
INDEX_NAME = "ix_group_context_messages_tenant_group_recent"
POSTGRES_CREATE = (
...
def upgrade() -> None:
    ...
    if _is_postgres():
        ...
        return
    op.create_index(INDEX_NAME, TABLE_NAME, ["tenant_id", "group_id", "sent_at", "id"])
