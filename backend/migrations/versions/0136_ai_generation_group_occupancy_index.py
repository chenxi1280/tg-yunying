"""Index AI generation group occupancy.

Revision ID: 0136_ai_gen_group_occupancy
Revises: 0135_ai_generation_due_claim
...
revision = "0136_ai_gen_group_occupancy"
down_revision = "0135_ai_generation_due_claim"
branch_labels = None
depends_on = None
...
SQLITE_CREATE = (
    ...
    "CAST(JSON_EXTRACT(payload, '$.\"group_id\"') AS INTEGER), id) "
    "WHERE task_type = 'group_ai_chat' "
    "AND action_type = 'send_message' "
    "AND ((status = 'executing' "
